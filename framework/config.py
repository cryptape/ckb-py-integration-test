...
CKB_DEFAULT_CONFIG = {
    ...
    'ckb_rpc_modules': ["Net", "Pool", "Miner", "Chain", "Stats", "Subscription",
                        "Experiment", "Debug", "IntegrationTest"],
...
SPAWN_CONTRACT_PATH = f"{get_project_root()}/source/contract/spawn_peak_memory_2m_to_32m"
LOOP_CONTRACT_PATH = f"{get_project_root()}/source/contract/test_cases/loop_contract"
