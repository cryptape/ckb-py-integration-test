...
class TestDepTx(CkbTest):
    ...
    def test_01_send_sub_transaction_replace_dep_fail(self):
        ...
        with pytest.raises(Exception) as exc_info:
            self.Tx.send_transfer_self_tx_with_input(
                ...
                fee=20900,
                api_url=self.node1.getClient().url,
                dep_cells=[{"tx_hash": tx_hash, "index_hex": "0x0"}],
            )
    ...
    def test_send_child_transaction_with_unreplaced_dep(self):
        ...
        replace_hash = self.Tx.send_transfer_self_tx_with_input(
            ...
            fee=20900,
            api_url=self.node1.getClient().url,
            dep_cells=[{"tx_hash": tx2_hash, "index_hex": "0x0"}],
        )
    ...
    def test_conflicting_sub_transaction(self):
        ...
        replace_hash = self.Tx.send_transfer_self_tx_with_input(
            ...
            fee=20900,
            api_url=self.node1.getClient().url,
            dep_cells=[{"tx_hash": tx1_hash, "index_hex": "0x0"}],
        )
    ...
    def test_replacing_sub_tx_rejects_dependent_txs(self):
        ...
        dep_is_tx_hash = self.Tx.send_transfer_self_tx_with_input(
            [tx2_hash],
            ["0x0"],
            account_private2,
            output_count=2,
    ...
    def test_tx_with_pool_dep_cell_as_input_mines_successfully(self):
        ...
        dep_cell_hash = self.Tx.send_transfer_self_tx_with_input(
            [tx_hash],
            ["0x0"],
            account_private,
            output_count=2,
        ...
        input_cell_hash = self.Tx.send_transfer_self_tx_with_input(
            [tx2_hash],
            ["0x0"],
            account_private2,
            output_count=2,
