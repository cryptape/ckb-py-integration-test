...
class TestGetCellsCapacity:
    ...
    def test_get_cells_capacity_output_data_filter_mode(self, get_cluster_indexer):
        ...
        get_cells_capacity_ret_byIndex = (
            cluster.ckb_nodes[0]
            .getClient()
            .get_cells_capacity(
                {
        ...
        get_cells_capacity_ret_byRichIndex = (
            cluster.ckb_nodes[1]
            .getClient()
            .get_cells_capacity(
                {
        ...
        assert (
            get_cells_capacity_ret_byRichIndex["capacity"]
            == get_cells_capacity_ret_byIndex["capacity"]
            == ret["objects"][0]["output"]["capacity"]
        )
        ...
        get_cells_capacity_ret_byIndexer = (
            cluster.ckb_nodes[0]
            .getClient()
            .get_cells_capacity(
                {
        ...
        get_cells_capacity_ret_byRichIndexer = (
            cluster.ckb_nodes[1]
            .getClient()
            .get_cells_capacity(
                {
        ...
        assert (
            get_cells_capacity_ret_byRichIndexer["capacity"]
            == get_cells_capacity_ret_byIndexer["capacity"]
            == ret["objects"][0]["output"]["capacity"]
        )
        ...
        try:
            ...
            assert (
                "CKB indexer doesn't support search_key.script_search_mode partial search mode"
                in str(e)
